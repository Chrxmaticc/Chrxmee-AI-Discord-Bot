...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(sub => sub.setName('reset').setDescription('Reset your pet data')),
  ...
  async execute(interaction, client) {
    ...
    if (sub === 'reset') {
      ...
      return interaction.editReply('✅ Pet data fully reset. All pets unowned and deactivated!');
    }

    // ── RESET
    if (sub === 'reset') {
      client.memory.delete(key);
      return interaction.editReply('✅ Pet data fully reset! All owned pets and active pets cleared.');
    }
