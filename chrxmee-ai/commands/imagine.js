    ...
    try {
      const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            { role: "system", content: "You are an expert AI image prompt engineer. Create a highly detailed, cinematic, and professional image generation prompt based on the user's idea." },
