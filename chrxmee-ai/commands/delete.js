...
module.exports = new ChrxCommandBuilder({
  ...
  async run(interaction) {
    ...
    try {
      ...
      // Generate random deletion order
      ...
      for (let i = 0; i < frames; i++) {
        ...
        // Delete blocks up to this frame
        ...
        for (let j = 0; j < deletedCount; j++) {
          ...
          // "Glitch" effect - random colored squares
        ...
        ctx.fillRect(0, size - 20, size * progress, 20);
      ...
      await interaction.editReply({
        content: `🗑️ **${target.displayName}** has been DELETED.`,
        files: [attachment],
      });
